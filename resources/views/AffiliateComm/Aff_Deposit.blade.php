  ...
  <section class=" bg-white">
    <div class="container border p-2 ">
      ...
      <div class="row ">
        <div class="col-lg-3 col-md-4">
          <div class=" row p-2">
            <label for="inputEmail3" class="col-sm-12 ">Affiliate Name</label>
            <div class="col-sm-12">
        ...
        <div class="col-lg-3 col-md-4">
          ...
          <div class=" row p-2">
            <label for="inputEmail3" class="col-sm-12 ">Merchant Bank Name</label>
            <div class="col-sm-12">
              <select class="form-control">
                <option></option>
                <option></option>
        ...
        <div class="col-md-6 d-flex align-items-end">
             <div class=" row ">
              <label class="col-sm-2 d-flex align-items-center justify-content-lg-center">Status</label>
            ...
            <table class="table datatables_all border">
              <thead>
                <tr class="bg-dark text-white">
                  ...
                  <th scope="col">Merchant Bank Acc</th>
