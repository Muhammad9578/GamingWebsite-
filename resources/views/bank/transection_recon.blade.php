...
<div class="col-md-12">
	...
	<hr>
<div class="row">
	<div class="col-md-12 overflow-auto py-3 ">
		<caption><h6 class="px-3" >Deposit</h6></caption>
		<table class="table datatables_all  table-striped table-bordered cms_table" cellspacing="0">
			<thead class="thead-dark">
				<tr class="">
					<th scope="col" class="big_col">Bank Account/PG</th>
					<th scope="col" class="big_col">Total Amount</th>
					<th scope="col" class="big_col">Bank Balance</th>
					<th scope="col" class="big_col">Approved Transections</th>
					<th scope="col" class="big_col">Rejected Transections</th>
				</tr>
			</thead>
			<tbody>
			</tbody>
...
<div class="row">
	<div class="col-md-12 overflow-auto py-3 ">
		<caption><h6 class="px-3" >Withdrawal</h6></caption>
		<table class="table datatables_all  table-striped table-bordered cms_table" cellspacing="0" >
			<thead class="thead-dark">
				<tr class="">
					<th scope="col" class="big_col">Bank Account/PG</th>
...
<div class="row">
	<div class="col-md-12 overflow-auto py-3 ">
		<caption><h6 class="px-3" >Transfer</h6></caption>
		<table class="table datatables_all  table-striped table-bordered cms_table" cellspacing="0">
			<thead class="thead-dark">
				<tr class="">
					<th scope="col" class="big_col">Bank Account/PG</th>
...
<div class="row py-2">
	<div class="col-md-12 overflow-auto py-3 ">
		<caption><h6 class="px-3" >Affilliate Deposit</h6></caption>
		<table class="table datatables_all  table-striped table-bordered cms_table" cellspacing="0" >
			<thead class="thead-dark">
				<tr class="">
					<th scope="col" class="big_col">Bank Account/PG</th>
...
<div class="row py-2">
	<div class="col-md-12 overflow-auto py-3 ">
		<caption><h6 class="px-3" >Affilliate Withdrawal</h6></caption>
		<table class="table datatables_all  table-striped table-bordered cms_table" cellspacing="0" >
			<thead class="thead-dark">
				<tr class="">
					<th scope="col" class="big_col">Bank Account/PG</th>
